...
- The 3-phase GitHub Actions pipeline will automatically trigger:
     ...
     2. SonarQube Cloud SAST (Self-Hosted) on `https://sonarqube.fainko.cloud` using active **`Sonar agentic AI`** quality profiles for Python (306 rules), JS (365 rules), and TS (376 rules) with Python 3.13 `coverage.xml`.
     3. Post-Scan Quality Gate Gatekeeper (Enforcing 0 new violations and 0% duplication).
