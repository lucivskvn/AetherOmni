...
2. **SonarQube Deep SAST**: Scans `main` on pushes and passes the GitHub pull-request number, source branch, and target branch for every PR scan on `https://sonarqube.fainko.cloud`, using Sonar rules with coverage.
